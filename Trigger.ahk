...
tAudio = %1%    ; Volume which triggers program (lowest = 0.00, highest = 1.00)
tLimit = %2%     ; Number of periods where audio is over tAudio to trigger program (set as tCounter below)
tDLimit = %3%     ; Periods of delay before we reset tCounter to 0
pDelay = %4%       ; Number of seconds that programs are muted and screen is blacked out
pPunish = %5%      ; Number of seconds that are added to pDelay for everytime we have to black out
fSize = %6%       ; Size of Font on Blackout
